...
ENV FTB_INFINITY_URL https://addons-origin.cursecdn.com/files/2320/899/FTBInfinityServer_2.6.0.zip
...
ENV LEVEL_TYPE BiomesOP
# ENV ENABLE_RCON
# ENV FORCE_GAMEMODE
ENV LEVEL_SEED nopixeldickinmate
# ENV SERVER_IP
...
ENV MOTD eat a bag of dicks eh?